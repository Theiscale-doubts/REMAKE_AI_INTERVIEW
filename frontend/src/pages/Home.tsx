...
export default function Home() {
  return (
    <div className="min-h-screen bg-ink text-txt-hi font-display antialiased selection:bg-acc-cyan/40 flex flex-col">
      ...
      <main className="flex-1 w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-6 grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-14 items-start">
        {/* Hero */}
        <section className="relative text-left pt-0 lg:pt-9 animate-fade-up">
          ...
          <div className="relative mt-8 flex items-center justify-start gap-3.5 flex-wrap">
            <Link href="/interview" className="w-full sm:w-auto">
              <button className="vh-btn-primary group w-full sm:w-auto justify-center px-8 py-4 text-[15px]">
            ...
            <Link href="/admin" className="w-full sm:w-auto">
              <button className="group inline-flex items-center gap-2.5 whitespace-nowrap w-full sm:w-auto justify-center rounded-xl border border-[rgba(201,154,114,.3)] bg-[rgba(201,154,114,.05)] px-6 py-4 text-[14.5px] font-medium text-acc-copper transition-all duration-200 hover:-translate-y-px hover:border-[rgba(201,154,114,.55)] hover:bg-[rgba(201,154,114,.1)]">
                <Lock className="h-3.5 w-3.5" />
                Admin
              </button>
            </Link>
          </div>
          <div className="relative mt-10 sm:mt-[52px] flex items-center gap-1 h-11 max-w-[420px] justify-start overflow-hidden">
            {WAVE_BARS.map((b, i) => (
              <span
                key={i}
        ...
        <section id="guidelines" className="scroll-mt-24">
          ...
          >
            <div className="px-5 sm:px-7 pt-[22px] pb-[18px] border-b border-hairline">
            ...
            <div className="px-5 sm:px-7 py-6 flex flex-col gap-[22px]">
            ...
            <div className="px-5 sm:px-7 py-[22px] grid grid-cols-1 xs:grid-cols-2 gap-3">
